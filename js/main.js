...
const comandos = {
    ...
    "quién te creo": () => {
        voz("Me crearon los estudiantes de la Universidad de Guayaquil, de la facultad de filosofia, de la carrera de informatica. Actualmente soy un prototito de asistente virtual desarrollada en visual studio code y javascritp");
    },

    "qué eres": () => {
        voz("soy un asistente virtual de la página EIDEA. Mi hogar");
    },
    ...
    "de que trata el proyecto": () => {
        voz(" Es un proyecto educativo creado por estudiantes de la facultad de filosofia de la carrera de informatica. Este proyecto contiene una informacion importante acerca del uso de plataformas educativas que desarrollan y promueven el aprendizaje significativo.");
    },
